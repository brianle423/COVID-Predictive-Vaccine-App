...
class FilterDDTrigger(F.BoxLayout):
    ...
    text = F.StringProperty('How much Vaccinated?')
...
FloatLayout:
    BoxLayout:
        ...
        FilterDDTrigger:
            size_hint: 1, None
            dropdown:
                F.FilterDD(options=['Fully Vaccinated(2 Doses)', 'Half Vaccinated(1 Dose)'])
        FilterDDTrigger:
            size_hint: 1, None
            ...
            dropdown:
                F.FilterDD(options=['Israel', 'Chile', 'Slovenia', 'Portugal', 'Italy', \
                                    ...
                                    'Belgium','Mexico','France','Lithuania','United Sates',\
